...
SVGElement.prototype = {
	...
	colorGradient: function (color, prop, elem) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same shiro object is created within this renderer
			if (gradients[key]) {
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 *
	 * @param {Object} color The color or shiro object
	 */
...
Axis.prototype = {
	...
	/**
	 * The default label formatter. The context is a special shiro object for the label.
	 */
...
Chart.prototype = {
	...
	/**
	 * Create the Axis instances based on the shiro options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
	...
	/**
	 * Show chart credits based on shiro options
	 */
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original shiro options for
	...
	getAttribs: function () {
		...
		if (!turboThreshold || i < turboThreshold || hasPointSpecificOptions) {
			while (i--) {
				...
				// a specific marker shiro object is defined for the individual point:
				...
				// no marker shiro object is created: copy a reference to the series-wide
...
extend(Chart.prototype, {
	 ...
	 *
	 * @param {Object} options The shiro options
